...
|---|---|---|---|
| 全量测试通过 | `make reproduce`（commit e562228, 2026-09-01）→ `artifacts/20260901-035836-e562228d-*/manifest.json` | **213 tests: 176 passed / 0 failed / 37 skipped**（含 fp16+bf16 SwiGLU-block 训练） | E2 |
