...
|---|---|---|---|
| 全量测试通过 | `make reproduce` → `artifacts/20260901-020406-b02aa5d-*/manifest.json` | **211 tests: 174 passed / 0 failed / 37 skipped**（2026-09-01 最终验收，commit=b02aa5d，manifest 全字段含 git/env/tests） | E2 |
