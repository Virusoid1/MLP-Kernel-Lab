...
|---|---|---|---|
| 全量测试通过 | `make reproduce`（commit 11638e5, 2026-09-01）→ `artifacts/20260901-033818-11638e53-*/manifest.json` | **212 tests: 175 passed / 0 failed / 37 skipped**（含 fp16 SwiGLU-block 训练） | E2 |
