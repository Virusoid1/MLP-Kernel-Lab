...
| cutile tile 优化（3070, 2026-09）+ **Blackwell 负结果（2026-09-02）** | `gpu_utils.py` ampere cutile_matmul_tile (32,32,32)→(32,64,32)；5070 Ti 84-row sweep | 3070 K=4096 54.5→34.3ms（1.6x）；**5070 Ti cutile fp16 62.7ms / bf16 59.9ms（3070 的 5x 慢）——ct.mma 在 sm120 未获 tcgen05 加速** | **3070 真实改进 + Blackwell 负结果如实记录（推翻旧假设）** | E3(数据) |
